 export const products = [
  ...
  },
  {
    ...
    desc: "Our General Cleaners are engineered to address a broad spectrum of industrial cleaning challenges, from routine maintenance to demanding production environments. Designed to effectively remove oils, greases, machining residues, and process contaminants, these formulations support equipment reliability, process efficiency, and surface readiness. Suitable for a variety of metallic substrates, they deliver consistent cleaning performance while aligning with modern environmental and workplace safety standards.",
  ...
  },
  {
    ...
    desc: "Bio-Circle Cleaners combine advanced cleaning chemistry with biological regeneration technology to provide long-lasting and environmentally responsible cleaning performance. Utilizing naturally occurring microorganisms, these solutions continuously degrade oils and contaminants, significantly extending bath life and reducing waste generation. Ideal for maintenance workshops, manufacturing facilities, and production operations, Bio-Circle technology helps organizations improve sustainability while lowering operating costs and enhancing process efficiency.",
  ...
  },
  {
    ...
    desc: "Our Acidic Cleaners are specifically formulated to remove oxidation, scale, mineral deposits, and other inorganic contaminants that compromise equipment performance and system efficiency. Developed for demanding industrial applications, these solutions restore heat transfer efficiency, improve fluid flow, and support asset longevity across pipelines, cooling systems, heat exchangers, and process equipment. Their targeted action ensures effective contaminant removal while maintaining operational integrity.",
  ...
  },
  {
    ...
    category: "Cleaners",
    title: "Finishers",
    desc: "Our Finisher solutions are designed to enhance surface quality and prepare components for subsequent manufacturing, assembly, coating, or storage processes. From residue-free cleaning and flash-drying applications to corrosion protection and surface conditioning, these products help maintain appearance, functionality, and long-term performance. By ensuring clean, protected, and process-ready surfaces, they contribute to improved product quality and operational consistency.",
  ...
  },
  {
    ...
    desc: "Our Surface Protection Solutions help safeguard metal surfaces against corrosion, environmental exposure, and handling-related contamination. Developed to maintain surface integrity after cleaning, finishing, or welding operations, these products provide a protective barrier that supports product quality, extends service life, and reduces maintenance requirements. Ideal for components requiring storage, transportation, or extended operational durability.",
